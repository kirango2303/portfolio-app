...
function Recommend() {
    ...
    return (
        <div className="body">
            <div className="two">
                <h1>Get Similar Stocks
                    <span>Enter a Stocks Symbol to Generate Recommendations. Reset before Searching Again.</span>
                </h1>
            </div>
            <div className="bar">
            ...
            <div className="buttons">
                ...
                <button className="button" onClick={reset}>Reset and Search Again</button>
            </div>
            <div>
            {count !== 5 && "Enter Search. Reset before Searching again. If you see no result, you may have entered invalid stocks symbol"}
            </div>
            ...
            <div className="company-container">
                ...
                <div>
                    <div>
                        {searchedStocks && similarStocks && count === 5 && "We found 5 alternatives"}
                    </div> 
                    {searchedStocks &&
                ...
                <div>
                    <div>{similarStocks && searchedStocks && count == 5 && "You searched for:"}</div>
                    <div>
